    ...
    <section className="hero-pattern text-white py-24">
      <div className="container mx-auto px-4 gap-4 flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2 mb-10 lg:mb-0">
          ...
          <p className="text-xl mb-8">Create QR codes for your belongings that help good Samaritans return them if lost. Set rewards, share contact info safely, and track everything from one dashboard.</p>
